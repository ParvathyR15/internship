...
const withDefaultOptions = (extraOptions) => {
    const defaultHeaders = {
        'Content-Type': 'application/json',
    };
    const extraHeaders = extraOptions && extraOptions.headers;
    const headers = Object.assign(Object.assign({}, defaultHeaders), extraHeaders);
    return Object.assign({ headers }, extraOptions);
};
...
const stringifyQuery = (query) => {
    ...
    return Object.entries(query).map(([key, value]) => e(key) + '=' + e(value)).join('&');
};
const onPending = (params, options) => {
...
const onReject = ({ response, message }) => {
...
describe('basic post/put/delete usage', () => {
    test('basic post', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect.assertions(1);
        const result = yield postUser({ name: 'Ruth Jones' });
    ...
    test('basic put', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect.assertions(1);
        const result = yield putUser({ id: '620000199004298120', name: 'Betty Martinez' });
    ...
    test('basic delete', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect.assertions(1);
        const result = yield deleteUser({ id: '140000200609308281' });
...
describe('basic createInterface urlTemplate usage', () => {
    ...
    test('basic resolve', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect.assertions(1);
        const result = yield getUser({ id: 1 });
...
describe('cover several usage', () => {
    test('form post', () => __awaiter(void 0, void 0, void 0, function* () {
        const postUser = createInterface('POST', '/users', {
            headers: {
        ...
        expect.assertions(1);
        const result = yield postUser({ name: 'Cynthia Gonzalez' });
        expect(result).toStrictEqual({ id: '810000199301039884', name: 'Cynthia Gonzalez' });
    }));
    test('X-App-Version changed', () => __awaiter(void 0, void 0, void 0, function* () {
